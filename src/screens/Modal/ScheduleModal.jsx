...
import StartTimeModal from '../Modal/StartTimeModal.jsx';
import FinishTimeModal from '../Modal/FinishTimeModal.jsx';
import Loader from '../../components/Loader';
import { useSendDayTimersMutation, useSendTimersMutation } from '../../redux/usersApi';

function ScheduleModal({ modalVisible, setModalVisible, controllers, setSuccessText, setSpeedSuccess, setSpeedError, setErrorText, dayTimers, unitParams }) {
  ...
  //  LOG  dayTimers { "timers": [{ "friday": "1", "monday": "1", "saturday": "1", "sunday": "0", "thusday": "0", "tuesday": "1", "wednesday": "1" }], "vent-unit": [{ "id_vent-unit": 6 }] }
  ...
  const getWeekString = () => {
    return serverDaysOrder.map(day => selectedDays.includes(day) ? '1' : '0').join('');
  };
        ...
        <View style={styles.modalView} {...panResponder.panHandlers}>
          ...
          <View style={styles.boxAutoRunContainer}>
            ...
            <View style={styles.boxAutoRun}>
              ...
              <Text style={styles.autoRunHeaderValue}>{temperatureSchedule}°</Text>
